...
const LogIn = () => {
    return (
        ...
        left-2/4 transform -translate-x-2/4 -translate-y-2/4">
            ...
            <div className=" reletive my-5">
                <input className="w-full border-2 rounded-3xl border-gray-400 bg-transparent p-1.5 pl-3 " placeholder='Password' type="password" required></input>
            ...
            <div className="pt-5 flex justify-center">
                ...
                <img className="ml-2 border-2 border-blue-600 rounded-full p-1 w-10 h-10 transform hover:scale-125 hover: cursor-pointer" src={google} alt="google" />
            </div>
